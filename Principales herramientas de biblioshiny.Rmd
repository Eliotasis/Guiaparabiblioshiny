...
- Palabras, las cuales aparecen juntas en un documento, estarán relacionadas en una red. Este tipo de redes son cocnocidas como redes de co-ocurrencia. Esta estructura puede ser usada para entender los temas cubiertos por un tema de estudio y definir cuales son los mas importantes o recientes (frente de investigación). También puede ayudar en el estudio de la evolución de los temas a lo largo del tiempo. 
...
Existen dos aproximaciones básicas al estudio de la estructura conceptual de un campo de estudio: La aproximación factorial y el estudio de redes. La idea básica detrás del estudio factorial consiste en reducir la dimensionalidad de los datos y representarlos en un espacio de dimensionalidad baja. Se parte de una matriz de "documentos" y "palabras clave" de la cuál se extrae información para la representación y el agrupamiento en un espacio bidimensional. El estudio de redes parte de matrices palabras clave y palabras clave tanto en filas como en columnas, para observar que palabras clave suelen aparecer juntas y ofrecer representaciones de redes de co-ocurrencia. 
