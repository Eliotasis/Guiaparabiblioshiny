...
Podemos realizar un cálculo de las resvistas que forman parte del "núcleo" a través de la ley de bradford ([ver anexo](#bradford)), que se encuentra en `Sources>Bradford´s law`.  
...
- Mayor indice $g$ y $m$ lo que nos habla de que presenta mas artículos muy citados y mas impacto en relación al tiempo que lleva la revista en activo, respectivamente. 
...
En la pestaña `Table` nos muestra una tabla con los paises ordenados por frecuencia productiva. 
...
En cuanto a los paises más importantes en este campo tenemos USA, Brasil, España, Argentina y Alemania. 

- La mayoría de los autores son estadounidenses, además Estados Unidos es el más productivo y el segundo más citado. 

- Brásil es el segundo pais con más autores y segundo más productivo. Se trata del quinto páis mas citado. 

- España es el tercer pais con mas autores y el tercero más productivo. Curiosamente, se trata del pais más citado, probablemente debido a los trabajos de Bascompte. 

- Argentina es el cuarto país con más autores, el cuarto más productivo y el quinto más citado. 

- Alemanía es el quinto país que más autores ofrece, el quitno más productivo y el cuarto más citado. 

Estados unidos presenta relativamente menos nivel de colaboración con otros paises que los demás. Brasil y España presenta una colaboración de casi el 50% de sus documentos con otros paises, mientras que Argentina y Alemania presenta colaboraciones en más de la mitad de sus artículos. 
...
En la pestaña `Intelectual Structure>Co-citation Network` podemos generar redes de co-citación de artículos, autores y papers. Pondremos como ejemplo una red de co-citación de autores, que puede darnos información sobre qué grupos de autores interactuan mas entre ellos. 
...
En la pestaña `Social Structure>Collaboration Network` podemos generar una red de colaboración.  A diferencia de las redes de co-citación, las redes colaboración unen nodos (generalmente autores) cuando presentan artículos donde ambos figuran como co-autores. 
